...
---
## Установка
1) Убедитесь, что у вас стоит Minecraft fabric 1.21.4
2) Установите моды:
...
/evoextras, /ex - открывает меню конфигурации
/evoextraswidgets, /exw - открывает меню редактирования виджетов

## Ссылки
Вы можете **получить помощь**, **сообщить о баге** или **предложить идеи** здесь:
### [**Discord сервер Evo Extras**](https://discord.gg/sx4TXM2NX8)
